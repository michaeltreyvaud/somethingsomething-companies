...
const CleaningTaskValidator = require('../validation/CleaningTaskValidator');
...
class CleaningTaskController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    ...
    this.Validator = CleaningTaskValidator;
  ...
  async create(req, res, next) {
    ...
    try {
      ...
      const {
        cleaningLocation, cleaningItem, team, user, day, time, description,
      } = body;
      const date = Date.now();
      const Item = {
        company: CompanyName,
...
module.exports = CleaningTaskController;
