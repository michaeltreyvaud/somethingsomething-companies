...
const SafetyCategoryValidator = require('../validation/SafetyCategoryValidator');

class SafetyItemController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = SafetyCategoryValidator;
...
module.exports = SafetyItemController;
