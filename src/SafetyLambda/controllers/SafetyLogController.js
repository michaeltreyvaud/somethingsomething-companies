...
const SafetyLogValidator = require('../validation/SafetyLogValidator');

class SafetyLogController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = SafetyLogValidator;
  ...
  async create(req, res, next) {
    ...
    try {
      ...
      const {
        SafetyItem, temperature, user, image, comments, signature,
      } = body;
      const date = Date.now();
      const Item = {
        company: CompanyName,
...
module.exports = SafetyLogController;
