...
const TrainingLogValidator = require('../../validation/User/TrainingLogValidator');

class TrainingLogController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = TrainingLogValidator;
  ...
  async create(req, res, next) {
    ...
    try {
      ...
      const {
        fromDate, toDate, trainingType, certification, details,
      } = body;
      const date = Date.now();
      const Item = {
        company: CompanyName,
...
module.exports = TrainingLogController;
