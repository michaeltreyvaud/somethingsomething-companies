...
const FreezerTaskValidator = require('../../validation/FreezerTaskValidator');

class FreezerTaskController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = FreezerTaskValidator;
  ...
  async create(req, res, next) {
    ...
    try {
      ...
      const {
        freezerItem, team, user, day, time, description
      } = body;
      const date = Date.now();
      const Item = {
        company: CompanyName,
...
module.exports = FreezerTaskController;
