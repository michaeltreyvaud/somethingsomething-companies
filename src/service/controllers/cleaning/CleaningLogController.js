...
const CleaningLogValidator = require('../../validation/CleaningLogValidator');

class CleaningLogController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = CleaningLogValidator;
...
module.exports = CleaningLogController;
