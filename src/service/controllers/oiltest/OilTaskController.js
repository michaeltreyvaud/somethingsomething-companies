...
const OilTestTaskValidator = require('../../validation/OilTestTaskValidator');

class OilTestTaskController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = OilTestTaskValidator;
...
module.exports = OilTestTaskController;
