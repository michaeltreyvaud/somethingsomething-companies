...
const OilTestLogValidator = require('../../validation/OilTestLogValidator');

class OilTestLogController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = OilTestLogValidator;
  ...
  async create(req, res, next) {
    ...
    try {
      ...
      const {
        oilTestLocation, oilTestItem, user, image, comments, signature, status
      } = body;
      const date = Date.now();
      const Item = {
        company: CompanyName,
...
module.exports = OilTestLogController;
