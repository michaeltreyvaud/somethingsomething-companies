...
const FridgeTaskValidator = require('../../validation/FridgeTaskValidator');

class FridgeTaskController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = FridgeTaskValidator;
  ...
  async create(req, res, next) {
    ...
    try {
      ...
      const {
        fridgeItem, team, user, day, time, description
      } = body;
      const date = Date.now();
      const Item = {
        company: CompanyName,
...
module.exports = FridgeTaskController;
