...
const TransportLogValidator = require('../validation/TransportLogValidator');

class FridgeLogController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = TransportLogValidator;
  ...
  async create(req, res, next) {
    ...
    try {
      ...
      const {
        fridgeItem, temperature, user, image, comments, signature,
      } = body;
      const date = Date.now();
      const Item = {
        company: CompanyName,
...
module.exports = FridgeLogController;
