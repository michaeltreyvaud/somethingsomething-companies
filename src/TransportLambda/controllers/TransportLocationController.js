...
const TransportLocationValidator = require('../validation/TransportLocationValidator');
...
class FridgeItemController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    ...
    this.Validator = TransportLocationValidator;
...
module.exports = FridgeItemController;
