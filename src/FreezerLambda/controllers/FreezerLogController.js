...
const FreezerLogValidator = require('../validation/FreezerLogValidator');

class FreezerLogController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = FreezerLogValidator;
  ...
  async create(req, res, next) {
    ...
    try {
      ...
      const {
        freezerItem, temperature, user, image, comments, signature,
      } = body;
      const date = Date.now();
      const Item = {
        company: CompanyName,
...
module.exports = FreezerLogController;
