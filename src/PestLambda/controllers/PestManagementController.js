...
const PestManagementValidator = require('../validation/PestManagementValidator');

class PestManagementController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = PestManagementValidator;
...
module.exports = PestManagementController;
