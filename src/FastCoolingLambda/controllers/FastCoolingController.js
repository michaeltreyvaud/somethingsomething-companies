...
const FastCoolingValidator = require('../validation/FastCoolingValidator');

class FastCoolingController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = FastCoolingValidator;
...
module.exports = FastCoolingController;
