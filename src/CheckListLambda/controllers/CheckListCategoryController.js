...
const CheckListCategoryValidator = require('../validation/CheckListCategoryValidator');

class CheckListCategoryController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = CheckListCategoryValidator;
...
module.exports = CheckListCategoryController;
