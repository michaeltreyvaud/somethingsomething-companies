...
const DeliveryItemValidator = require('../validation/DeliveryItemValidator');

class DeliveryItemController {
  constructor(Logger, DocumentClient, CompanyName, TableName) {
    this.Logger = Logger;
    this.CompanyName = CompanyName;
    this.TableName = TableName;
    this.DocumentClient = DocumentClient;
    this.Validator = DeliveryItemValidator;
  ...
  async create(req, res, next) {
    ...
    try {
      ...
      const {
        user,  supplier, orderNumber, temperature, image, deliveryType, conditions, signature, comments, status
      } = body;
      const date = Date.now();
      const Item = {
        company: CompanyName,
...
module.exports = DeliveryItemController;
